exports.seed = async function(knex) {
  await knex("fruits").truncate() //resets and clears out all rows in the table - using truncate resets the auto increment value of pk!! so use truncate instead of del()
